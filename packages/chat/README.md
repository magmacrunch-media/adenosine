...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@magmacrunch/adenosine-chat@0.6/chat-widget.css">
<script src="https://cdn.jsdelivr.net/npm/@magmacrunch/adenosine-chat@0.6/dist/index.global.js"></script>
```
...
```
new SharedWorker('https://cdn.jsdelivr.net/npm/@magmacrunch/adenosine-chat@0.6/dist/chat-worker.js')
